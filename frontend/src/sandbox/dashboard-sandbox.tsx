...
const SCENARIOS: Record<string, Partial<SandboxConfig>> = {
  ...
  "codemaster-with-guesses": {
    ...
    guessesRemaining: 1,
    guesses: [
      { cardWord: "WEB", playerName: "Agent Jones", outcome: "CORRECT_TEAM_CARD" },
      { cardWord: "SECURE", playerName: "Agent Jones", outcome: "CORRECT_TEAM_CARD" },
    ],
    roundStatus: "IN_PROGRESS",
    hasRound: true,
    hasCards: true,
  ...
  "codebreaker-hit-neutral": {
    ...
    guesses: [
      { cardWord: "WEB", playerName: "Agent Jones", outcome: "CORRECT_TEAM_CARD" },
      { cardWord: "SECURE", playerName: "Agent Jones", outcome: "CORRECT_TEAM_CARD" },
      { cardWord: "LOCK", playerName: "Agent Jones", outcome: "BYSTANDER_CARD" },
    ],
    roundStatus: "IN_PROGRESS",
    hasRound: true,
    hasCards: true,
  },
  "codebreaker-hit-enemy": {
    role: "CODEBREAKER",
    teamName: "Blue",
    playerName: "Agent Jones",
    activeTeamName: "Blue",
    ...
    guessesRemaining: 0,
    guesses: [
      { cardWord: "WAVE", playerName: "Agent Jones", outcome: "CORRECT_TEAM_CARD" },
      { cardWord: "FIRE", playerName: "Agent Jones", outcome: "OTHER_TEAM_CARD" },
    ],
    roundStatus: "IN_PROGRESS",
    hasRound: true,
    hasCards: true,
  ...
  spectator: {
    ...
    guessesRemaining: 1,
    guesses: [
      { cardWord: "SPY", playerName: "Agent Smith", outcome: "CORRECT_TEAM_CARD" },
    ],
    roundStatus: "IN_PROGRESS",
    hasRound: true,
    hasCards: true,
...
export const DashboardSandbox: React.FC = () => {
  ...
  const scenarioGroups = useMemo(
    () => ({
      ...
      Codemaster: ["codemaster-giving-clue", "codemaster-waiting", "codemaster-with-guesses", "codemaster-other-team"],
      Codebreaker: [
        "codebreaker-guessing",
        "codebreaker-mid-turn",
        "codebreaker-hit-neutral",
