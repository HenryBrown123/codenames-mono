...
import { CARD_COLORS } from "./card-utils";
...
export const coverDealAnimation = keyframes`
  0% {
...
export const colorRevealAnimation = keyframes`
  0% {
...
export const assassinSweep = keyframes`
  0% {
...
export const electricFlicker = keyframes`
  0%, 100% {
    opacity: 0.6;
...
export const paperTextureStyles = css`
  &::after {
    content: "";
    position: absolute;
    inset: 0;
 ...
 */
export const BaseCard = styled.button<{ $teamColor: string; $clickable: boolean }>`
